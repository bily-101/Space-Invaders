...
fun main () {
    ...
    var invaderBullet = oo(spaceInvader.x, spaceInvader.y)
    var invaderBullets = mutableListOf<oo>()

    var tank = oo(wnd.width / 2, wnd.height / 2 + 30)


    var bullet = oo(wnd.width / 2 + 29, wnd.height / 2 - 40)
